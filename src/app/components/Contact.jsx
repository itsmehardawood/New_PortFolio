...
function Contact() {
  return (
    <div className="min-h-screen w-full bg-gray-200 text-black flex items-center flex-col py-5">
      ...
      <div className="flex items-center mt-10 flex-col text-gray-900 w-[50%]">
        <form className="bg-white p-8 shadow-lg rounded-lg w-full">
          <div className="mb-4">
